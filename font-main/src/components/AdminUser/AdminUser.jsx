...
//     return { ...user, key: user._id, role: user.role ? 'TRUE' : 'FALSE' }
//   })
...
//               label="Name"
//               name="hoTenKH"
//               rules={[{ required: true, message: 'Please input your hoTenKH!' }]}
//             >
//               <InputComponent value={stateUserDetails['hoTenKH']} onChange={handleOnchangeDetails} name="hoTenKH" />
//             </Form.Item>
