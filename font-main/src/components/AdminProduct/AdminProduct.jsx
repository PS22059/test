...
const AdminProduct = () => {
    ...
    const typeLabels = {
        '6605bf1cde52efd7ebe1af82': 'Hạt Xấy Khô',
        '6605bf36de52efd7ebe1af94': 'Hạt Tươi',
        '6605bf43de52efd7ebe1af98': 'Hạt Ít Béo',
        '6605bf52de52efd7ebe1af9c': 'Hạt Nhiều Béo'
    };
    const columns = [
        {
            title: 'Name',
        ...
        },
        {
            title: 'Type',
            dataIndex: 'type',
            render: typeCode => typeLabels[typeCode] || typeCode
        },
        {
            title: 'Action',
            dataIndex: 'action',
