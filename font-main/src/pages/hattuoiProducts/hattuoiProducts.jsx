...
import hatuoiProductsComponent from '../../components/hatuoiProductsComponent/hatuoiProductsComponent';
...
const HattuoiProducts = () => {
  ...
  const fetchProductAll = async (context) => {
    ...
    const res = await ProductService.getAllProductByType(search, limit, 'Hạt Tươi').then((res) => {
...
export default HattuoiProducts;
